...
public class AccountEx {
    public static void main(String[] args) {
        ...
        // 마이너스 한도
        CreditLineAccount creditLineAccount = new CreditLineAccount("111", "홍길동", 100000, 500000000);
        ...
        // 교통카드
        CheakingTrafficCardAccount cardAccount = new CheakingTrafficCardAccount("111", "홍길동", 100000, null);
        CheakingTrafficCardAccount cardAccount2 = new CheakingTrafficCardAccount("333", "성춘향", 100000, null);
