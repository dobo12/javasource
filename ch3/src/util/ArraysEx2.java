...
public class ArraysEx2 {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.equals(original, cloned) ? "배열요소 같음" : "배열요소 다음");
        ...
        System.out.println(Arrays.equals(original, cloned2) ? "배열요소 같음" : "배열요소 다음");
        System.out.println(Arrays.deepEquals(original, cloned2) ? "배열요소 같음" : "배열요소 다음");
    }
}
